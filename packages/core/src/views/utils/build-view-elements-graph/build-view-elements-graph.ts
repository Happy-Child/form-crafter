...
export const buildViewElementsGraph = (elements: ViewElements, slots: Slots = {}): ViewElementsGraph => {
    const execute = (
        ...
        elements.forEach((row) => {
            ...
            children.forEach(({ id: componentId, children = [], layout }) => {
                ...
                result.components[finalComponentId] = {
                    id: finalComponentId,
                    parentRowId: finalRowId,
                    layout,
                    ...(isNotEmpty(childrenRows) ? { childrenRows } : null),
                }
            })
